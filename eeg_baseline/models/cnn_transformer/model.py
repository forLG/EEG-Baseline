...
class CNNTransformer(nn.Module):
    """
    The full CNN-Transformer model for EEG artifact detection.

    Args:
        n_classes (int): Number of output classes. Default is 2 (artifact vs non-artifact).
        n_channels (int): Number of EEG channels. 
        L_seconds (int): Length of the input EEG segment in seconds. 
        fs (int): Sampling frequency of the EEG signal. 
        kwargs: Additional keyword arguments.

        Notes: fs * L_seconds should be the input length of sample.
    """
    def __init__(
        self, 
        num_classes: int, 
