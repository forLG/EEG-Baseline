...
def get_dataset(args):
    if args.dataset == 'TUAB':
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_TUSZ_dataset("/data/zhaoliming/guwei/processed/TUSZ/labram")
        ch_names = ['FP1', 'FP2', 'F3', 'F4', 'C3', 'C4', 'P3', 'P4', 'O1', 'O2', 'F7', 'F8', 'T3', 'T4', 'T5', 'T6', 'A1', 'A2', 'FZ']
        args.nb_classes = 2
        metrics = ["accuracy", "balanced_accuracy", "f1_weighted"]
    elif args.dataset == 'HMC':
        train_dataset, test_dataset, val_dataset = utils.prepare_HMC_dataset("/data/zhaoliming/guwei/processed/HMC/labram")
        ch_names = ['F4', 'C3', 'C4', 'O2']
        args.nb_classes = 4
        metrics = ["accuracy", "balanced_accuracy", "f1_weighted"]
